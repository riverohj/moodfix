  ...
  return (
    <div className="session-inline-nudge">
      ...
      <div className="session-inline-nudge-actions">
        <button
          className="session-choice-button session-choice-button-secondary"
          type="button"
          onClick={onContinue}
        >
  ...
  return (
    <ViewShell compact>
      <div className="session-question-shell">
        ...
        <StepArrow disabled={!canAdvance || searching} onClick={onNext}>
    ...
    <div className="rc-stars" onMouseLeave={() => setHovered(null)}>
      {[1, 2, 3, 4, 5].map((stars) => (
        <button
          ...
          className={`rc-star ${stars <= active ? "rc-star-on" : ""}`}
          key={stars}
          type="button"
...
function ResultCard({
  ...
  return (
    <article
      className={`rc-feature ${action === "seen" ? "rc-feature-seen" : ""} ${action === "saved" ? "rc-feature-saved" : ""}`}
    >
      <div className="rc-feature-media">
        <div className="rc-poster rc-poster-feature" aria-hidden="true">
          ...
          {action === "saved" ? (
            <span className="rc-poster-badge rc-poster-badge-saved">Ver luego</span>
          ) : null}
          {action === "seen" && !showRating ? (
            <span className="rc-poster-badge rc-poster-badge-seen">
              Vista {rating ? `· ${"★".repeat(rating)}` : ""}
            </span>
          ) : null}
        </div>
      </div>
      ...
      <div className="rc-feature-body">
        ...
        {actionNotice ? (
          <p className="session-feedback session-feedback-success rc-inline-notice">
            {actionNotice}
          </p>
        ) : null}
        {actionError ? (
          <p className="session-feedback session-feedback-error rc-inline-error">{actionError}</p>
        ) : null}
