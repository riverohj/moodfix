...
import { deleteWatchlistMovie, getWatchlistMovies } from "../src/lib/api";
import {
  formatLanguageLabel,
  formatPopularity,
  formatVoteCount,
          ...
          <div className="library-modal-body">
            ...
            <div className="library-modal-facts">
              <div className="library-modal-fact">
                ...
                <span className="library-modal-fact-value">
...
export default function Favorites({ onProfileChange, token }) {
    ...
    <section className="favorites-screen">
      ...
      {loading ? (
        ...
        <section className="favorites-empty-card">
          ...
          <p>
            Cuando en sesión pulses <strong>Ver luego</strong>, tus pelis aparecerán aquí para
            recuperarlas rápido.
          </p>
                ...
                {movie.poster_path ? (
                  <img
                    ...
                    onError={(event) => {
                      event.target.onerror = null;
                      event.target.style.display = "none";
                      event.target.parentNode.classList.add("favorito-poster-has-fallback");
                    }}
                  />
                ) : (
