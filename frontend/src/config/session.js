...
export const MOOD_OPTIONS = [
  { id: "acelerar_corazon",      label: "❤️‍🔥 Acelerar el corazón" },
...
export const TIME_OPTIONS = [
  { id: "algo_rapido",  label: "⚡ Algo rápido",   sublabel: "menos de 90 min" },
  { id: "tengo_tiempo", label: "🕐 Tengo tiempo",  sublabel: "sin límite" },
];
...
export const DISCOVERY_OPTIONS = [
  { id: "seguro",    label: "🛡️ Ir a lo seguro" },
  { id: "descubrir", label: "🎲 Descubrir algo nuevo" },
];

export const ERA_OPTIONS = [
  { id: "actual",  label: "🎬 Actual",   sublabel: "desde 2015" },
  { id: "moderna", label: "📼 Moderna",  sublabel: "1990 – 2014" },
  { id: "clasica", label: "🎞️ Clásica",  sublabel: "antes de 1990" },
];
